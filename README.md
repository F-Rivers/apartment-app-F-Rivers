# Apartment App
This app is the Apartment Department, used for finding a new apartment. The app has CRUD functionality and uses various elements to make UX and UI easy to understand. 
